<template>
  <header class="flex items-center justify-between border-b border-gray-200 px-3 sm:px-5 py-3 bg-white">
    ...
    <div class="flex items-center">
      ...
      <button class="ml-6 focus:outline-none flex-shrink-0">
