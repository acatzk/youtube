<template>
  <header class="flex items-center justify-between border-b border-gray-300 px-4 py-2 bg-white h-16">
      ...
      <div class="flex items-center justify-center space-x-2">
        <form class="flex">
          ...
          <button @click.prevent class="border-t border-r border-b rounded-r-sm border-gray-400 py-1 px-6 bg-gray-100 text-sm hover:bg-gray-200 transition ease-in-out duration-150 focus:outline-none">
            <svg class="w-4 h-4 text-gray-600" fill="currentColor" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" preserveAspectRatio="xMidYMid meet"><path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
          </button>
        </form>
    ...
    <div class="flex items-center">
      <ul class="flex items-center space-x-0 sm:space-x-1 md:space-x-2">
        ...
        <li class="block sm:hidden">
          <button class="focus:outline-none rounded-full p-2 hover:bg-gray-200 transition ease-in-out duration-150">
            <svg class="w-6 h-6 text-gray-700" fill="currentColor" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" preserveAspectRatio="xMidYMid meet"><path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
          </button>
        </li>
        <li>
          <button class="focus:outline-none rounded-full p-2 hover:bg-gray-200 transition ease-in-out duration-150">
            <svg class="w-6 h-6 text-gray-700 rounded-full fill-current" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><path d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4zM14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2z" class="style-scope yt-icon"></path></svg>
          </button>
        </li>
        <li>
          <button class="focus:outline-none rounded-full p-2 hover:bg-gray-200 transition ease-in-out duration-150">
            <svg class="w-6 h-6 text-gray-700 rounded-full fill-current" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><path d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z"></path></svg>
          </button>
        </li>
        <li>
          <button class="focus:outline-none rounded-full p-2 hover:bg-gray-200 transition ease-in-out duration-150">
            <svg class="w-6 h-6 text-gray-700 rounded-full fill-current" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z"></path></svg>
          </button>
        </li>
        <li class="pl-3">
          <button class="focus:outline-none flex-shrink-0 p-2">
            <img class="w-8 h-8 bg-gray-500 rounded-full object-cover border border-gray-200" src="@/assets/images/avatar.jpg" alt="">
          </button>
        </li>
      </ul>
    </div>
